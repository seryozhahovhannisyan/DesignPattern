...
Object state will be inconsistent until unless all the attributes are set explicitly.

Builder pattern solves the issue with large number of optional parameters
and inconsistent state by providing a way to
...
Java Builder class should have methods to set the optional parameters and it should return
